...
#ifndef __CONFIG_GS1_H__
#define __CONFIG_GS1_H__
...
#define CONFIG_PMU_RICOH618
#define CONFIG_RICOH618_I2C_SCL	GPIO_PB(23)
#define CONFIG_RICOH618_I2C_SDA	GPIO_PB(24)
#define CONFIG_SOFT_I2C_READ_REPEATED_START
#define CONFIG_BATTERY_VOLTAGE_MAX		4350
#endif
...
#define CONFIG_BOOTARGS CONFIG_SPL_BOOTARGS

#define CONFIG_BOOTCOMMAND "bootu"
/**
 * for ota boot
 * 0x80efffc0 = 0x80f00000 - sizeof(struct image_header) to eacape the header on zImage.
 */
#define CONFIG_BOOTX_BOOTARGS BOOTARGS_COMMON "ip=off root=/dev/ram0 rw rdinit=/linuxrc"
#define CONFIG_UPDATE_BOOTCOMMAND "mmc dev 0;mmc read 0x80efffc0 0xa800 0x4000; bootx mem 0x80f00000"
#define CONFIG_NORMAL_BOOTCOMMAND "bootx sfc 0x80f00000 0x100000"
