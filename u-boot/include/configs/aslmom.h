...
#ifdef CONFIG_GET_BAT_PARAM
#define CONFIG_SPL_BOOTARGS         BOOTARGS_COMMON "rootfstype=cramfs root=/dev/mtdblock3 bat=2200"
#else
...
/* useless on aslmon board, only for compiling pass. */
...
#define CONFIG_SYS_SPL_OTA_ARGS_ADDR BOOTARGS_COMMON "ip=off init=/linuxrc rootfstype=cramfs root=/dev/mtdblock4 rw"
