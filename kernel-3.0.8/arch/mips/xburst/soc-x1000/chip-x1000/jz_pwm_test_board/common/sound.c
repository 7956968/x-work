...
struct snd_codec_data tas5010_codec_data = {
	.gpio_spk_en = {.gpio = GPIO_TAS5010_SPEAKER_EN, .active_level = GPIO_TAS5010_SPEAKER_EN_LEVEL},

};

struct platform_device tas5010_device = {
		.name = "tas5010_codec",
};
#endif
