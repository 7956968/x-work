...
#if defined(CONFIG_BCMDHD_43455) || defined(CONFIG_BCMDHD_43455_8021AS)
int bcm_ap6255_wlan_init(void);
int bcm_ap6255_manual_sysfs_init(struct device *dev);
#endif

#ifndef CONFIG_JZ_SFC
...
struct jzmmc_platform_data tf_pdata = {
	...
	.capacity  			= MMC_CAP_SD_HIGHSPEED | MMC_CAP_MMC_HIGHSPEED | MMC_CAP_NONREMOVABLE,
#else
