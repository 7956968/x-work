...
#define GPIO_BOOT_SEL1		GPIO_PB(29)*///JJJHHH
#define GPIO_NW5027_P3_KEY 		1
#define GPIO_NW5027_P3_KEY0 	GPIO_PC(23)//RESET
#define GPIO_KEY_LIKE 	GPIO_PA(0)
#define GPIO_KEY_PALYPAUSE 	GPIO_PA(13)
#define GPIO_KEY_RECORD 	GPIO_PA(14)
#define GPIO_KEY_VOLDOWN 	GPIO_PC(26)
#define GPIO_KEY_VOLUP 	GPIO_PC(27)
#define GPIO_KEY_MODE 	GPIO_PA(15)
#define ACTIVE_LOW_POWERDOWN 	1
#define ACTIVE_LOW_F4 		0
#define ACTIVE_LOW_F5 		0
#define ACTIVE_LOW_NW5027_P3_KEY		1
/* ****************************GPIO KEY END******************************** */
...
#define GPIO_SPEAKER_EN    	-1//GPIO_PC(22)         /*speaker enable gpio*/
...
#define GPIO_AK4425_4104_PDN		-1       /* GPIO_AK4425_4104_PDN pin */
#define GPIO_AK4425_4104_SPEAKER_EN		GPIO_PC(22)       /* amp shutdown pin */
#define GPIO_AK4425_4104_SPEAKER_EN_LEVEL	1
#define GPIO_AK4425_4104_AMP_POWER_EN	-1		/* amp power enable pin */
#define GPIO_AK4425_4104_AMP_POWER_EN_LEVEL	-1
#define GPIO_AK4425_4104_LINEIN_DETECT          -1   /*linein detect gpio*/
#define GPIO_AK4425_4104_LINEIN_INSERT_LEVEL    0
#define GPIO_AK4425_4104_HP_DETECT  	-1      	/*hp detect gpio*/
#define GPIO_AK4425_4104_HP_INSERT_LEVEL    -1
#endif
