...
struct snd_codec_data ak4425_4104_codec_data = {
	.codec_sys_clk = 0,
	/* volume */
	/* nau8824 -104db~24db, 0.5db step */
	.replay_digital_volume_base = 50,

	.gpio_spk_en = {.gpio = GPIO_AK4425_4104_SPEAKER_EN, .active_level = GPIO_AK4425_4104_SPEAKER_EN_LEVEL},
	.gpio_amp_power = {.gpio = GPIO_AK4425_4104_AMP_POWER_EN, .active_level = GPIO_AK4425_4104_AMP_POWER_EN_LEVEL},
	.gpio_hp_detect = {.gpio = GPIO_AK4425_4104_HP_DETECT, .active_level = GPIO_AK4425_4104_HP_INSERT_LEVEL},
	.gpio_linein_detect = {.gpio = GPIO_AK4425_4104_LINEIN_DETECT, .active_level = GPIO_AK4425_4104_LINEIN_INSERT_LEVEL},
};

struct platform_device ak4425_4104_codec_device = {
