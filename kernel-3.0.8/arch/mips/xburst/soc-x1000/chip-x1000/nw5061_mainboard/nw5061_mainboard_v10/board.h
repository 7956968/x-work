...
#define GPIO_USB_DETE           GPIO_PC(24) /*GPIO_PB(8)*///JJJHHH
...
#define GPIO_SPEAKER_EN    	GPIO_PA(18)//GPIO_PC(25)         /*speaker enable gpio*/
...
#define GPIO_LINEIN_DETECT          GPIO_PA(17)      /*linein detect gpio*/
...
#define GPIO_AKM4753_PDN		-1//GPIO_PB(8)       /* AKM4753 PDN pin */
#define GPIO_AKM4753_SPEAKER_EN		-1//GPIO_PB(11)       /* amp shutdown pin */
...
#define GPIO_AKM4753_LINEIN_DETECT          GPIO_PA(17)   /*linein detect gpio*/
...
#define GMAC_PHY_PORT_GPIO GPIO_PA(19)//JJJHHH GPIO_PB(3)
#define GMAC_PHY_ACTIVE_HIGH 0//JJJHHH 1
...
#define GPIO_EFUSE_VDDQ			-1//GPIO_PC(27)	/* EFUSE must be -ENODEV or a gpio */
