...
static uint32_t halley2_keymap[] =
{
	//KEY(row, col, keycode)
...
static struct matrix_keymap_data halley2_keymap_data =
{
	.keymap = halley2_keymap,
	.keymap_size =ARRAY_SIZE(halley2_keymap),
};

struct matrix_keypad_platform_data halley2_keypad_data  =
{
	.keymap_data = &halley2_keymap_data,
...
struct platform_device jz_matrix_kdb_device = {
	...
	.id		= 0,
	.dev		= {
		.platform_data  = &halley2_keypad_data,
	}
};
...
#endif
#ifdef GPIO_AIRKISS_KEY
    {
                .gpio                           = GPIO_AIRKISS_KEY,
                .code = {
                        .shortpress_code        = KEY_F1,
                        .longpress_code         = KEY_RESERVED,
                },
                .desc                           = "airkiss key",
                .active_low                     = ACTIVE_LOW_AIRKISS,
                .longpress_interval             = 0,
                .debounce_interval              = 2,
        },
#endif
#ifdef GPIO_NEXTSONG_KEY
    {
                .gpio                           = GPIO_NEXTSONG_KEY,
                .code = {
                        .shortpress_code        = KEY_NEXTSONG,
                        .longpress_code         = KEY_RESERVED,
                },
                .desc                           = "next song key",
                .active_low                     = ACTIVE_LOW_NEXTSONG,
                .longpress_interval             = 0,
                .debounce_interval              = 2,
        },
#endif
