...
struct jz_camera_pdata halley2_camera_pdata = {
	.mclk_10khz = 2400,
	.flags = 0,
...
struct platform_device halley2_front_camera_sensor = {
...
static int __init halley2_board_cim_init(void) {
	/* camera host */

#ifdef CONFIG_VIDEO_JZ_CIM_HOST
	jz_device_register(&jz_cim_device, &halley2_camera_pdata);
#endif
	/* camera sensor */
#ifdef CONFIG_SOC_CAMERA
	platform_device_register(&halley2_front_camera_sensor);
#endif

	return 0;
}

core_initcall(halley2_board_cim_init);
