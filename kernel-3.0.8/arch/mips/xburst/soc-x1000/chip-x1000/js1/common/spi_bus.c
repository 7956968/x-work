...
#define UPDATAFS_SIZE   0xc00000  /* 12M */
...
#define SIZE_OTA		(SIZE_KERNEL + SIZE_UPDATERFS) /* should >= SIZE_KERNEL + SIZE_UPDATERFS */
...
struct spi_board_info jz_ssi0_board_info[]  = {

        [0] ={
                .modalias               =  "spidev",
                .platform_data          =  NULL,
                .controller_data        = (void *)GPIO_PD(1), /* cs for spi gpio */
                .max_speed_hz           = 12000000,
                .bus_num                = 0,
                .chip_select            = 0,
                .mode                   = SPI_MODE_3,
...
int jz_ssi0_devs_size = ARRAY_SIZE(jz_ssi0_board_info);
#endif
...
struct jz_spi_info spi0_info_cfg = {
	...
	.num_chipselect = 1,
	.allow_cs_same  = 1,
	.chipselect     = {GPIO_PD(1),GPIO_PD(1)},
};
#endif
