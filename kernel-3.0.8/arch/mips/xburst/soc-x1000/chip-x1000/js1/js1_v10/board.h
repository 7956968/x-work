...
#define GPIO_BOOT_SEL2		GPIO_PB(30)
...
#define GPIO_SPEAKER_EN    	GPIO_PB(13)         /*speaker enable gpio*/
...
#define GPIO_LCD_CS     	GPIO_PB(18)
#define GPIO_LCD_RST    	GPIO_PD(5)
#define GPIO_BL_PWR_EN  	GPIO_PA(25)
#define GPIO_BL_PWR_EN_LEVEL 	LOW_ENABLE
