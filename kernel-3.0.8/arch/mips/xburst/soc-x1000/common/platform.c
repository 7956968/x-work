...
#if (defined(CONFIG_JZ_EXTERNAL_CODEC_V12) || defined(CONFIG_JZ_EXTERNAL_CODEC_V13) || defined(CONFIG_SOUND_JZ_SPDIF_V13))
	I2S_PORTB,
#endif
...
#if (defined(CONFIG_SND_ASOC_JZ_I2S_EXTCODEC) || defined(CONFIG_SND_ASOC_JZ_AIC_SPDIF_V13))
	I2S_PORTB,
#endif

#if (defined(CONFIG_JZ_DMIC0) || defined(CONFIG_SND_ASOC_JZ_DMIC0))
    DMIC0_PORTB,
#endif
#if (defined(CONFIG_JZ_DMIC1) || defined(CONFIG_SND_ASOC_JZ_DMIC1))
    DMIC1_PORTB,
#endif
