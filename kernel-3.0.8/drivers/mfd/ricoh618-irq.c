...
static int gpedge_add[] = {
	RICOH618_GPIO_GPEDGE1,
	RICOH618_GPIO_GPEDGE2
};
...
static int irq_en_add[] = {
	...
	RICOH618_INT_MSK_CHGEXTIF
};

static int irq_mon_add[] = {
	RICOH618_INT_IR_SYS,		/* RICOH618_INT_MON_SYS, */
	RICOH618_INT_IR_DCDC,		/* RICOH618_INT_MON_DCDC, */
	RICOH618_INT_IR_RTC,		/* RICOH618_INT_MON_RTC, */
	RICOH618_INT_IR_ADCL,
	RICOH618_INT_IR_ADCH,
	RICOH618_INT_IR_ADCEND,
	RICOH618_INT_IR_GPIOR,
	RICOH618_INT_IR_GPIOF,
	RICOH618_INT_IR_CHGCTR,		/* RICOH618_INT_MON_CHGCTR, */
	RICOH618_INT_IR_CHGSTS1,	/* RICOH618_INT_MON_CHGSTS1, */
	RICOH618_INT_IR_CHGSTS2,	/* RICOH618_INT_MON_CHGSTS2, */
	RICOH618_INT_IR_CHGERR,		/* RICOH618_INT_MON_CHGERR */
	RICOH618_INT_IR_CHGEXTIF	/* RICOH618_INT_MON_CHGEXTIF */
};
...
static const struct ricoh618_irq_data ricoh618_irqs[RICOH618_NR_IRQS] = {
	...
	[RICOH618_IRQ_CTC]		= RICOH618_IRQ(RTC_INT,  2, 0, 0, 2),
	[RICOH618_IRQ_DALE]		= RICOH618_IRQ(RTC_INT,  2, 1, 6, 2),

	[RICOH618_IRQ_ILIMLIR]		= RICOH618_IRQ(ADC_INT,  3, 0, 0, 3),
	[RICOH618_IRQ_VBATLIR]		= RICOH618_IRQ(ADC_INT,  3, 1, 1, 3),
	[RICOH618_IRQ_VADPLIR]		= RICOH618_IRQ(ADC_INT,  3, 2, 2, 3),
	[RICOH618_IRQ_VUSBLIR]		= RICOH618_IRQ(ADC_INT,  3, 3, 3, 3),
	[RICOH618_IRQ_VSYSLIR]		= RICOH618_IRQ(ADC_INT,  3, 4, 4, 3),
	[RICOH618_IRQ_VTHMLIR]		= RICOH618_IRQ(ADC_INT,  3, 5, 5, 3),
	[RICOH618_IRQ_AIN1LIR]		= RICOH618_IRQ(ADC_INT,  3, 6, 6, 3),
	[RICOH618_IRQ_AIN0LIR]		= RICOH618_IRQ(ADC_INT,  3, 7, 7, 3),

	[RICOH618_IRQ_ILIMHIR]		= RICOH618_IRQ(ADC_INT,  3, 8, 0, 4),
	[RICOH618_IRQ_VBATHIR]		= RICOH618_IRQ(ADC_INT,  3, 9, 1, 4),
	[RICOH618_IRQ_VADPHIR]		= RICOH618_IRQ(ADC_INT,  3, 10, 2, 4),
	[RICOH618_IRQ_VUSBHIR]		= RICOH618_IRQ(ADC_INT,  3, 11, 3, 4),
	[RICOH618_IRQ_VSYSHIR]		= RICOH618_IRQ(ADC_INT,  3, 12, 4, 4),
	[RICOH618_IRQ_VTHMHIR]		= RICOH618_IRQ(ADC_INT,  3, 13, 5, 4),
	[RICOH618_IRQ_AIN1HIR]		= RICOH618_IRQ(ADC_INT,  3, 14, 6, 4),
	[RICOH618_IRQ_AIN0HIR]		= RICOH618_IRQ(ADC_INT,  3, 15, 7, 4),

	[RICOH618_IRQ_ADC_ENDIR]	= RICOH618_IRQ(ADC_INT,  3, 16, 0, 5),

	[RICOH618_IRQ_GPIO0]		= RICOH618_IRQ(GPIO_INT, 4, 0, 0, 6),
	[RICOH618_IRQ_GPIO1]		= RICOH618_IRQ(GPIO_INT, 4, 1, 1, 6),
	[RICOH618_IRQ_GPIO2]		= RICOH618_IRQ(GPIO_INT, 4, 2, 2, 6),
	[RICOH618_IRQ_GPIO3]		= RICOH618_IRQ(GPIO_INT, 4, 3, 3, 6),
	[RICOH618_IRQ_GPIO4]		= RICOH618_IRQ(GPIO_INT, 4, 4, 4, 6),

	[RICOH618_IRQ_FVADPDETSINT]	= RICOH618_IRQ(CHG_INT, 6, 0, 0, 8),
	[RICOH618_IRQ_FVUSBDETSINT]	= RICOH618_IRQ(CHG_INT, 6, 1, 1, 8),
	[RICOH618_IRQ_FVADPLVSINT]	= RICOH618_IRQ(CHG_INT, 6, 2, 2, 8),
	[RICOH618_IRQ_FVUSBLVSINT]	= RICOH618_IRQ(CHG_INT, 6, 3, 3, 8),
	[RICOH618_IRQ_FWVADPSINT]	= RICOH618_IRQ(CHG_INT, 6, 4, 4, 8),
	[RICOH618_IRQ_FWVUSBSINT]	= RICOH618_IRQ(CHG_INT, 6, 5, 5, 8),

	[RICOH618_IRQ_FONCHGINT]	= RICOH618_IRQ(CHG_INT, 6, 6, 0, 9),
	[RICOH618_IRQ_FCHGCMPINT]	= RICOH618_IRQ(CHG_INT, 6, 7, 1, 9),
	[RICOH618_IRQ_FBATOPENINT]	= RICOH618_IRQ(CHG_INT, 6, 8, 2, 9),
	[RICOH618_IRQ_FSLPMODEINT]	= RICOH618_IRQ(CHG_INT, 6, 9, 3, 9),
	[RICOH618_IRQ_FBTEMPJTA1INT]	= RICOH618_IRQ(CHG_INT, 6, 10, 4, 9),
	[RICOH618_IRQ_FBTEMPJTA2INT]	= RICOH618_IRQ(CHG_INT, 6, 11, 5, 9),
	[RICOH618_IRQ_FBTEMPJTA3INT]	= RICOH618_IRQ(CHG_INT, 6, 12, 6, 9),
	[RICOH618_IRQ_FBTEMPJTA4INT]	= RICOH618_IRQ(CHG_INT, 6, 13, 7, 9),

	[RICOH618_IRQ_FCURTERMINT]	= RICOH618_IRQ(CHG_INT, 6, 14, 0, 10),
	[RICOH618_IRQ_FVOLTERMINT]	= RICOH618_IRQ(CHG_INT, 6, 15, 1, 10),
	[RICOH618_IRQ_FICRVSINT]	= RICOH618_IRQ(CHG_INT, 6, 16, 2, 10),
	[RICOH618_IRQ_FPOOR_CHGCURINT]	= RICOH618_IRQ(CHG_INT, 6, 17, 3, 10),
	[RICOH618_IRQ_FOSCFDETINT1]	= RICOH618_IRQ(CHG_INT, 6, 18, 4, 10),
	[RICOH618_IRQ_FOSCFDETINT2]	= RICOH618_IRQ(CHG_INT, 6, 19, 5, 10),
	[RICOH618_IRQ_FOSCFDETINT3]	= RICOH618_IRQ(CHG_INT, 6, 20, 6, 10),
	[RICOH618_IRQ_FOSCMDETINT]	= RICOH618_IRQ(CHG_INT, 6, 21, 7, 10),

	[RICOH618_IRQ_FDIEOFFINT]	= RICOH618_IRQ(CHG_INT, 6, 22, 0, 11),
	[RICOH618_IRQ_FDIEERRINT]	= RICOH618_IRQ(CHG_INT, 6, 23, 1, 11),
	[RICOH618_IRQ_FBTEMPERRINT]	= RICOH618_IRQ(CHG_INT, 6, 24, 2, 11),
	[RICOH618_IRQ_FVBATOVINT]	= RICOH618_IRQ(CHG_INT, 6, 25, 3, 11),
	[RICOH618_IRQ_FTTIMOVINT]	= RICOH618_IRQ(CHG_INT, 6, 26, 4, 11),
	[RICOH618_IRQ_FRTIMOVINT]	= RICOH618_IRQ(CHG_INT, 6, 27, 5, 11),
	[RICOH618_IRQ_FVADPOVSINT]	= RICOH618_IRQ(CHG_INT, 6, 28, 6, 11),
	[RICOH618_IRQ_FVUSBOVSINT]	= RICOH618_IRQ(CHG_INT, 6, 29, 7, 11),

	[RICOH618_IRQ_FGCDET]		= RICOH618_IRQ(CHG_INT, 6, 30, 0, 12),
	[RICOH618_IRQ_FPCDET]		= RICOH618_IRQ(CHG_INT, 6, 31, 1, 12),
	[RICOH618_IRQ_FWARN_ADP]	= RICOH618_IRQ(CHG_INT, 6, 32, 3, 12),
...
static void ricoh618_irq_unmask(struct irq_data *irq_data)
{
	...
	if (data->master_bit == 6)	/* if Charger */
		ricoh618->irq_en_reg[data->mask_reg_index]
						&= ~(1 << data->int_en_bit);
	else
		ricoh618->irq_en_reg[data->mask_reg_index]
						|= 1 << data->int_en_bit;
...
static irqreturn_t ricoh618_irq(int irq, void *data)
{
	...
	ret = ricoh618_read(ricoh618->dev, RICOH618_INTC_INTMON,
						&master_int);
	//printk(KERN_INFO "PMU1: %s: mas0ter_int=0x%x\n", __func__, master_int);
	if (ret < 0) {
	...
	for (i = 0; i < MAX_INTERRUPT_MASKS; ++i) {
		...
		if(irq_clr_add[i] == RICOH618_INT_IR_RTC)
		{
			int_sts[i] &= ~0x85;
...
static int  ricoh618_irq_base;
int ricoh618_irq_init(struct ricoh618 *ricoh618, int irq,
				int irq_base)
{
	int i, ret;
	u8 reg_data = 0;
	ricoh618_irq_base = irq_base;
	if (!irq_base) {
	...
	/* Initialize rtc */
	ricoh618->irq_en_cache[2] = 0x20;
	ricoh618->irq_en_reg[2] = 0x20;
	...
	for (i = 8; i < MAX_INTERRUPT_MASKS; i++) {
		ricoh618->irq_en_cache[i] = 0xff;
		ricoh618->irq_en_reg[i] = 0xff;
	}
	...
	for (i = 0; i < MAX_INTERRUPT_MASKS; i++)  {
		if (irq_clr_add[i] != RICOH618_INT_IR_RTC) {
			...
			ret = ricoh618_read(ricoh618->dev,
					RICOH618_INT_IR_RTC, &reg_data);
			if (ret < 0)
				dev_err(ricoh618->dev, "Error in reading reg 0x%02x "
					"error: %d\n", RICOH618_INT_IR_RTC, ret);
			reg_data &= 0xf0;
			ret = ricoh618_write(ricoh618->dev,
					RICOH618_INT_IR_RTC, reg_data);
			if (ret < 0)
	...
	ret = request_threaded_irq(irq, NULL, ricoh618_irq,
...
void ricoh618_irq_awake(void)
{
	struct irq_desc *desc;
	int i;
	for (i = 0; i < RICOH618_NR_IRQS; i++){
		int __irq = i + ricoh618_irq_base;
		desc = irq_to_desc(__irq);
		__enable_irq(desc, __irq, true);
	}
}
