...
static int codec_init(void)
{
	...
	int i;
	struct device *dev;
	struct es8374_platform_data *es8374;
...
static int __devinit es8374_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
        ...
        struct es8374_platform_data *es8374_data = dev->platform_data;
...
static int __devexit es8374_i2c_remove(struct i2c_client *client)
{
        struct device *dev = &client->dev;
        struct es8374_platform_data *es8374_data = dev->platform_data;
...
static struct i2c_driver es8374_i2c_driver = {
        ...
        .remove = __devexit_p(es8374_i2c_remove),
