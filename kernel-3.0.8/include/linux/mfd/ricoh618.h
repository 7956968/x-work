...
#define RICOH618_DC1_CTL		0x2C
#define RICOH618_DC1_CTL2		0x2D
#define RICOH618_DC2_CTL		0x2E
#define RICOH618_DC2_CTL2		0x2F
#define RICOH618_DC3_CTL		0x30
#define RICOH618_DC3_CTL2		0x31
#define RICOH618_DC4_CTL		0x32
#define RICOH618_DC4_CTL2		0x33
#define RICOH618_DC5_CTL		0x34
#define RICOH618_DC5_CTL2		0x35
#define RICOH618_LDOECO_SLP		0x4a
...
#define	RICOH618_CHG_STATE	       	0xBD
...
extern int ricoh618_bulk_reads(struct device *dev, u8 reg, u8 count,
								uint8_t *val);
extern int ricoh618_bulk_reads_bank1(struct device *dev, u8 reg, u8 count,
								uint8_t *val);
...
extern int ricoh618_bulk_writes(struct device *dev, u8 reg, u8 count,
								uint8_t *val);
extern int ricoh618_bulk_writes_bank1(struct device *dev, u8 reg, u8 count,
								uint8_t *val);
...
extern int ricoh618_update(struct device *dev, u8 reg, uint8_t val,
								uint8_t mask);
extern int ricoh618_update_bank1(struct device *dev, u8 reg, uint8_t val,
								uint8_t mask);
