...
#define FN_GET_BTN_PLAYPAUSE "BtnPlaypause"
#define FN_GET_BTN_VOLUMEUP "BtnVolumeup"
#define FN_GET_BTN_VOLUMEDOWN "BtnVolumedown"
...
#define FN_SET_VRswitch "VRswitch"
	#define SET_VRswitch "switch"
