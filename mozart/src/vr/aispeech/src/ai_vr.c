...
const char *wakeup_conf = "{"
	    ...
	    "\"provision\":\"/usr/share/vr/res/aiengine-2.8.8-14327742440003c5.provision\","
	    ...
	    "\"native\":{"
	        "\"cn.wakeup\":{"
	            "\"resBinPath\":\"/usr/share/vr/res/wakeup_aihome_aispeech_nhxl_20161019.bin\","
	            "\"useOutputBoundary\": 0"
	        "}"
	    "}"
	"}";
...
static const char *sds_conf ="{"
        ...
        "\"prof\":{"
            "\"enable\":0,"
            "\"output\":\"/mnt/sdcard/aiengine.log\""
        "},"
        "\"vad\":{"
            "\"enable\":1,"
