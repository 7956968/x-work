...
ifeq (${SUPPORT_APACHE},1)
	@$(call install_molib_package,output/molib/package/apache.list)
endif
#DAMAI_add end
# adb
...
#hzb add
ifeq ("nw5027lb_ap6212", "${PRODUCT_NAME}")nw5027lb_ap6212
...
ifeq ("$(1)","ubifs")
	sed -i 's/\(mount -t USRDATAFS\ \)\(.*\)\(\ \/usr\/data\)/\1ubi0:usrdata -o sync\3/g' $(UPDATERFS_DIR)/etc/init.d/S00system_init.sh
