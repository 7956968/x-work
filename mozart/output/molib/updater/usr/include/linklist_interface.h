 ...
 * @param priv[in] the private data for handle.
 */
extern void  list_traverse(List *list, void (*handle)(void *, void *), void *priv);

/**
 * @brief traverse the list with condition.
 *
 * @param list [in][out] the list that to be operated.
 * @param handle [in] the handler to traverse the list.
 * @param priv[in] the private data for handle.
 *
 * @return normal return or handle break return 0, handle error otherwise.
 */
extern int list_traverse_cond(List *list, int (*handle)(List *list, void *, void *), void *priv);
